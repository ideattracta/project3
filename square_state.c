...
int get_column_num(square_state s)
{
	...
	// Returns the value of the square_state variable's column field.
	return(s->column);
}
...
void set_column_num(square_state s, int c)
{
	...
	// Updates the value of the square_state variable's column field with the given int value.
	s->column = c;
...
bool occupied(square_state s)
{
	...
	// Returns true if the square has been visited (i.e. is true), and false otherwise.
	return (s->visited);
}
...
void occupy(square_state s, int c)
{
	...
	// Updates the value of the square_state variable's visited field to true and the move field to the given value.
	s->visited = true;
	s->move = c;
